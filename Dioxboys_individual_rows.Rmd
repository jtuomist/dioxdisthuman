...
boys <- read.csv("NuorDiox-Individual-Data_Jouni_2019-10-16.csv", header=TRUE, sep=";", dec=",")
...
moms <- read.csv("Äidinmaidot-kaikki_yhteenveto-SPSS-Siirto_2019-10-16.csv",
...
men <- read.csv("SPR-Diox-PCB.csv", header=TRUE, sep=";", dec=",", skip=2, stringsAsFactors = FALSE)
